...
main (int argc, char *argv[])
{
	...
	std::string alphasFile = "/home/wkli/ns3-datacenter/simulator/ns-3.39/examples/ABM/alphas"; // On lakewood
	std::string cdfFileName = "/home/wkli/ns3-datacenter/simulator/ns-3.39/examples/ABM/websearch.txt";
